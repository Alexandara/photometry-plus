...
class QMacToolBar(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, identifier:str, parent:typing.Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    ...
    def setAllowedItems(self, allowedItems:typing.Sequence): ...
    def setItems(self, items:typing.Sequence): ...
...
class QMacToolBarItem(PySide2.QtCore.QObject):
    ...
    def text(self) -> str: ...
@staticmethod
def qRegisterDraggedTypes(types:typing.Sequence): ...
