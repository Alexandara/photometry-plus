...
class QColor(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, spec:PySide2.QtGui.QColor.Spec, a1:int, a2:int, a3:int, a4:int, a5:int=...): ...
...
class QPixmapCache(Shiboken.Object):
    ...
    @typing.overload
    def find(self, arg__1:PySide2.QtGui.QPixmapCache.Key): ...
    @typing.overload
    @staticmethod
...
class QRegularExpressionValidator(PySide2.QtGui.QValidator):
    ...
    def __init__(self, parent:typing.Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, re:PySide2.QtCore.QRegularExpression, parent:typing.Optional[PySide2.QtCore.QObject]=...): ...

    def regularExpression(self) -> PySide2.QtCore.QRegularExpression: ...
    def setRegularExpression(self, re:PySide2.QtCore.QRegularExpression): ...
    def validate(self, input:str, pos:int) -> PySide2.QtGui.QValidator.State: ...
