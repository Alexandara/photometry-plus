...
enum : int {
    ...
    SBK_QSYSINFO_SIZES_IDX                                   = 269,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 267,
    SBK_QSYSINFO_MACVERSION_IDX                              = 268,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 270,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 271,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 272,
    SBK_QTEMPORARYDIR_IDX                                    = 273,
    SBK_QTEMPORARYFILE_IDX                                   = 274,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 275,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 277,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 276,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 114,
    SBK_QTEXTCODEC_IDX                                       = 278,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 279,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 115,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 280,
    SBK_QTEXTDECODER_IDX                                     = 281,
    SBK_QTEXTENCODER_IDX                                     = 282,
    SBK_QTEXTSTREAM_IDX                                      = 283,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 286,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 284,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 287,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 285,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 116,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 288,
    SBK_QTHREAD_IDX                                          = 289,
    SBK_QTHREAD_PRIORITY_IDX                                 = 290,
    SBK_QTHREADPOOL_IDX                                      = 291,
    SBK_QTIME_IDX                                            = 292,
    SBK_QTIMELINE_IDX                                        = 293,
    SBK_QTIMELINE_STATE_IDX                                  = 296,
    SBK_QTIMELINE_DIRECTION_IDX                              = 295,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 294,
    SBK_QTIMEZONE_IDX                                        = 297,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 300,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 298,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 299,
    SBK_QTIMER_IDX                                           = 301,
    SBK_QTIMEREVENT_IDX                                      = 302,
    SBK_QTRANSLATOR_IDX                                      = 303,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 304,
    SBK_QURL_IDX                                             = 305,
    SBK_QURL_PARSINGMODE_IDX                                 = 307,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 308,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 306,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 117,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 309,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 119,
    SBK_QURLQUERY_IDX                                        = 310,
    SBK_QUUID_IDX                                            = 311,
    SBK_QUUID_VARIANT_IDX                                    = 313,
    SBK_QUUID_VERSION_IDX                                    = 314,
    SBK_QUUID_STRINGFORMAT_IDX                               = 312,
    SBK_QVARIANTANIMATION_IDX                                = 315,
    SBK_QVERSIONNUMBER_IDX                                   = 316,
    SBK_QWAITCONDITION_IDX                                   = 317,
    SBK_QWRITELOCKER_IDX                                     = 318,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 319,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 320,
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 320,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 321,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 322,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 323,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 324,
    SBK_QXMLSTREAMREADER_IDX                                 = 325,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 328,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 327,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 326,
    SBK_QXMLSTREAMWRITER_IDX                                 = 329,
    SBK_QtCoreQT_IDX                                         = 330,
    SBK_QT_GLOBALCOLOR_IDX                                   = 364,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 375,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 131,
    SBK_QT_MODIFIER_IDX                                      = 379,
    SBK_QT_MOUSEBUTTON_IDX                                   = 380,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 133,
    SBK_QT_ORIENTATION_IDX                                   = 385,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 135,
    SBK_QT_FOCUSPOLICY_IDX                                   = 359,
    ...
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 333,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 367,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 127,
    SBK_QT_BGMODE_IDX                                        = 338,
    SBK_QT_KEY_IDX                                           = 374,
    SBK_QT_ARROWTYPE_IDX                                     = 335,
    SBK_QT_PENSTYLE_IDX                                      = 388,
    SBK_QT_PENCAPSTYLE_IDX                                   = 386,
    SBK_QT_PENJOINSTYLE_IDX                                  = 387,
    SBK_QT_BRUSHSTYLE_IDX                                    = 339,
    SBK_QT_SIZEMODE_IDX                                      = 394,
    SBK_QT_UIEFFECT_IDX                                      = 410,
    SBK_QT_CURSORSHAPE_IDX                                   = 348,
    SBK_QT_TEXTFORMAT_IDX                                    = 400,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 336,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 351,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 122,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 352,
    SBK_QT_TOOLBARAREA_IDX                                   = 405,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 139,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 406,
    SBK_QT_DATEFORMAT_IDX                                    = 349,
    SBK_QT_TIMESPEC_IDX                                      = 403,
    SBK_QT_DAYOFWEEK_IDX                                     = 350,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 390,
    SBK_QT_CASESENSITIVITY_IDX                               = 340,
    SBK_QT_CORNER_IDX                                        = 347,
    SBK_QT_EDGE_IDX                                          = 354,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 124,
    SBK_QT_CONNECTIONTYPE_IDX                                = 344,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 392,
    SBK_QT_FILLRULE_IDX                                      = 357,
    SBK_QT_MASKMODE_IDX                                      = 377,
    SBK_QT_CLIPOPERATION_IDX                                 = 343,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 372,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 373,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 409,
    SBK_QT_AXIS_IDX                                          = 337,
    SBK_QT_FOCUSREASON_IDX                                   = 360,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 345,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 369,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 129,
    SBK_QT_INPUTMETHODHINT_IDX                               = 368,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 128,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 355,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 407,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 376,
    SBK_QT_ANCHORPOINT_IDX                                   = 332,
    SBK_QT_FINDCHILDOPTION_IDX                               = 358,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 125,
    SBK_QT_DROPACTION_IDX                                    = 353,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 123,
    SBK_QT_CHECKSTATE_IDX                                    = 341,
    SBK_QT_ITEMDATAROLE_IDX                                  = 370,
    SBK_QT_ITEMFLAG_IDX                                      = 371,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 130,
    SBK_QT_MATCHFLAG_IDX                                     = 378,
    ...
    SBK_QT_EVENTPRIORITY_IDX                                 = 356,
    SBK_QT_SIZEHINT_IDX                                      = 393,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 413,
    SBK_QT_COORDINATESYSTEM_IDX                              = 346,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 408,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 140,
    SBK_QT_GESTURESTATE_IDX                                  = 362,
    SBK_QT_GESTURETYPE_IDX                                   = 363,
    SBK_QT_GESTUREFLAG_IDX                                   = 361,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 126,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 383,
    SBK_QT_NAVIGATIONMODE_IDX                                = 384,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 422,
    SBK_QT_TIMERTYPE_IDX                                     = 404,
    SBK_QT_SCROLLPHASE_IDX                                   = 391,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 382,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 381,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 134,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 342,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 365,
